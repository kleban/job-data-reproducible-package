...
| 2 | `02_analyze_vacancy_skills_and_occupation_composition.ipynb` | Produce vacancy, skill, occupation, remote-work, and conflict-related descriptive outputs; write weekly/monthly datasets | Prepared and statically validated; ESCO and ACLED inputs included, but not executed |
