...
# The notebooks are expected to be run from the notebooks/ folder, so .env
...
class Config:
    ...
    Attributes:
        ...
        STAGE5_DAILY_UNIQUE_PKL_PATH (str): Daily unique records (pickle).
        ...
        STAGE5_DAILY_FULL_PKL_PATH (str): Daily full records (pickle).
        ...
        STAGE5_MONTHLY_FULL_JSON_PATH (str): Monthly full records (JSON).
    ...
    STAGE5_DAILY_UNIQUE_PKL_PATH: str = config["STAGE5_DAILY_UNIQUE_PKL_PATH"]
    ...
    STAGE5_DAILY_FULL_PKL_PATH: str = config["STAGE5_DAILY_FULL_PKL_PATH"]
    ...
    STAGE5_MONTHLY_FULL_JSON_PATH: str = config["STAGE5_MONTHLY_FULL_JSON_PATH"]
