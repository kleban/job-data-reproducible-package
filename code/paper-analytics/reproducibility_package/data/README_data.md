...
This directory contains the direct inputs to the self-contained R statistical project. The Parquet files are analysis-ready derived data, not the original vacancy snapshots. The Excel files provide energy and ACLED conflict inputs.
...
| `europe-central-asia_full_data_up_to-2025-07-25.xlsx` | ACLED conflict events used by script 00 | Script 00 | Yes |
...
- The included ACLED workbook has SHA-256 `875C78457FCD1B53CA6E4CB3DFA7D78E4FBAE16E6DEBE99964A535203FE50317`, matching the canonical copy under `data/paper-analytics/reference/acled/`. Its original download date, exact coverage, and redistribution conditions still require confirmation.
