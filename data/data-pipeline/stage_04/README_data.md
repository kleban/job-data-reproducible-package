# data/data-pipeline/stage_04 — Stage 4 Outputs (ESCO Skills Mapping)
...
The `manual_data_correction()` function in `code/data-pipeline/stage4.py` also applies
...
| `esco_title` | str | Verified ESCO preferred label after 5-step title/code matching |
...
> **Note:** The `output/` folder is empty in this repository.
